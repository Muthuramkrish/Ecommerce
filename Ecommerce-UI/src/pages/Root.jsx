                  ...
                  <div className="container-responsive">
                    <div className="flex items-center justify-between h-16 py-4">
                      <button
                        ...
                        className="flex items-center text-gray-600 hover:text-gray-900 transition-colors text-sm md:text-base touch-target"
                      >
                      ...
                      <h1 className="text-lg md:text-xl font-semibold text-gray-900 text-center flex-1 mx-4">{getGridTitle()}</h1>
