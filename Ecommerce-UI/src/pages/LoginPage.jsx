...
const LoginPage = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-slate-100 via-blue-50 to-slate-100 p-2 sm:p-4 lg:p-6 overflow-hidden">
      <div className="relative w-full max-w-[900px] h-full max-h-[600px] sm:max-h-[650px] lg:max-h-[600px] bg-white rounded-3xl sm:rounded-3xl shadow-3xl overflow-hidden">
        {/* Back Button */}
        <button
          type="button"
          onClick={() => window.history.back()}
          className="absolute top-3 left-3 sm:top-4 sm:left-4 z-40 w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-2xl bg-white/90 hover:bg-white border border-slate-200 text-slate-700 hover:text-slate-900 transition-all shadow-md hover:shadow-lg"
          aria-label="Go back"
        >
          ...
          <div className="w-full max-w-sm overflow-y-auto max-h-full py-4 custom-scrollbar">
            <form autoComplete="off" noValidate onSubmit={handleSignIn} className="w-full">
              ...
              <div className="flex justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <button type="button" className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 flex items-center justify-center rounded-full border-2 border-slate-300 hover:border-blue-500 hover:text-blue-500 transition-colors">
                  <Facebook size={14} className="sm:w-4 sm:h-4 lg:w-[18px] lg:h-[18px]" />
                </button>
                <button type="button" className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 flex items-center justify-center rounded-full border-2 border-slate-300 hover:border-pink-500 hover:text-pink-500 transition-colors">
                  <Instagram size={14} className="sm:w-4 sm:h-4 lg:w-[18px] lg:h-[18px]" />
                </button>
                <button type="button" className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 flex items-center justify-center rounded-full border-2 border-slate-300 hover:border-red-500 hover:text-red-500 transition-colors">
                  <Mail size={14} className="sm:w-4 sm:h-4 lg:w-[18px] lg:h-[18px]" />
                </button>
                <button type="button" className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 flex items-center justify-center rounded-full border-2 border-slate-300 hover:border-slate-700 hover:text-slate-700 transition-colors">
        ...
        <div className={`hidden md:block absolute top-0 h-full w-1/2 transition-all duration-700 ease-in-out z-20 ${active ? 'left-0' : 'left-1/2'
          ...
          <div className="relative w-full h-full bg-gradient-to-br from-blue-600 to-blue-800 overflow-hidden">
