...
const CartPage = ({ items, onBack, onUpdateQuantity, onRemoveItem, onCheckout, clearCart, onOpenDetails }) => {
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <h1 className="text-lg font-semibold text-gray-900 justify-center">Shopping Cart</h1>
            <div className="w-32" />
            <button 
              onClick={() => clearCart()}
              className="flex items-center text-gray-600 hover:text-gray-900 transition-colors text-sm md:text-base"
